...
betas=load('hie_inf_pred_beta_comp.mat');
betas=betas.beta_smc;
betas=betas(:,1);

gamma=load('hie_inf_pred_gamma_comp.mat');
gamma=gamma.gamma_smc;
gamma=gamma(:,1);

mu=load('hie_inf_pred_epsilon_comp.mat');
mu=mu.epsilon_smc;
mu=mu(:,1);
...
save('ext_prob_hie_pop16_comp.mat','ext_prob')
