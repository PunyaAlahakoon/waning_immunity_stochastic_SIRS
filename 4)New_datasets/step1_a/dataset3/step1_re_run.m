...
tic 
%load data
cc=[1 4 8 9 12 13]; %pops to re-run 
...
save('s_x_smc14.mat','s_x');
save('ind_uniform_beta14.mat','beta_smc');
save('ind_uniform_gamma14.mat','gamma_smc');
save('ind_uniform_epsilon14.mat','epsilon_smc');
save('AG_smc14.mat','AG_smc');
save('w_smc14.mat','w_smc');
toc
