...
B=5000; 
data=load('sc11_data.mat', 'data'); % load the dataset you need
...
save('hie_unif_beta.mat','beta_smc');
save('hie_unif_gamma.mat','gamma_smc');
save('hie_unif_epsilon.mat','epsilon_smc');
